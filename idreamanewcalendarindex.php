...
/**
 *  \file       idreamanewcalendar/idreamanewcalendarindex.php
 *  \ingroup    idreamanewcalendar
 *  \brief      Home page of idreamanewcalendar top menu
 */
...
$langs->loadLangs(["idreamanewcalendar@idreamanewcalendar"]);

$action = GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->idreamanewcalendar->read) {
	accessforbidden();
}
...
llxHeader("", $langs->trans("IDreamANewCalendarArea"));

print load_fiche_titre($langs->trans("IDreamANewCalendarArea"), '', 'idreamanewcalendar.png@idreamanewcalendar');
...
// Draft MyObject
if (! empty($conf->idreamanewcalendar->enabled) && $user->rights->idreamanewcalendar->read) {
	$langs->load("orders");
