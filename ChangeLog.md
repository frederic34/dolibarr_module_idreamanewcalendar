...
#### :memo: Documentation
* README entièrement mis à jour : nouvelles fonctionnalités, API AJAX (`getaction`, `updateaction`, `createaction`, pagination `getcustomers`/`getprojects`), format des événements EventCalendar v5. ([@frederic34](https://github.com/frederic34))
* Toutes les captures d'écran régénérées (Dolibarr 24.0-beta). Nouvelles captures : `popup-edition.png`, `popup-creation.png`, `calendrier-masque.png`. ([@frederic34](https://github.com/frederic34))
