...
/**
 * \file    idreamanewcalendar/admin/changelog.php
...
$page_name = "IDreamANewCalendarChangelog";
...
print load_fiche_titre($langs->trans($page_name), $linkback, 'object_idreamanewcalendar@idreamanewcalendar');

// Configuration header
$head = idreamanewcalendarAdminPrepareHead();
print dol_get_fiche_head($head, 'changelog', '', 0, 'idreamanewcalendar@idreamanewcalendar');
